package net.sansan.agrosarcane.block.pedestal;
...
import net.sansan.agrosarcane.block.BlockBase;
import net.sansan.agrosarcane.block.BlockTileEntity;
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player,
		...
		if(!world.isRemote) {
			...
			if(!player.isSneaking()) {
				...
				if(stack != null) {
					String localized = Agros_Arcane.proxy.localize(stack.getUnlocalizedName() + ".name");
